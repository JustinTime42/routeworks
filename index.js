...
app.get('/api/getroute/:routeName', (req, res) => {
    ...
    .select(db.raw('properties.key, properties.address, properties.route_name, properties.cust_name, properties.cust_phone, properties.surface_type, properties.is_new, properties.route_position, service_log.status, service_log.notes, service_log.user_name'))
