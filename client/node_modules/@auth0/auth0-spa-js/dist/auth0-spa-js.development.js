(function (global, factory) {
    ...
    */
    ...
    var parseQueryResult = function (queryString) {
        ...
        return __assign({}, parsedQuery, { expires_in: parseInt(parsedQuery.expires_in) });
    };
    ...
    var runPopup = function (popup, authorizeUrl, config) {
        ...
        return new Promise(function (resolve, reject) {
            var timeoutId = setTimeout(function () {
                reject(__assign({}, TIMEOUT_ERROR, { popup: popup }));
    ...
    var sha256 = function (s) { return __awaiter(_this, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve(window.crypto.subtle.digest({ name: 'SHA-256' }, new TextEncoder().encode(s)))];
                case 1:
                    response = _a.sent();
    ...
    var getJSON = function (url, options) { return __awaiter(_this, void 0, void 0, function () {
